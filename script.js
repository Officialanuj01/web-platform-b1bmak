...
// Your code goes here
studentProfile['hobbies'] = ['poertry', 'playing kabbdy', 'reading books'];
...
function books(tittle, author) {
  this.tittle = tittle;
  this.author = author;
}
var addBook = new books('Atomic habits', 'James Clear');

//Challenge 2.2: Access the title property of the object "Book" and print the same in console.
console.log(addBook.tittle);
